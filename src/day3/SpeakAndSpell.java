...
String words = JOptionPane.showInputDialog("READ INSTRUCTION spell the word said no caps");
if (words.equals("said")){
	speak("correct");
	String words = JOptionPane.showInputDialog("fart");
}
else{
	speak("incorrect");
